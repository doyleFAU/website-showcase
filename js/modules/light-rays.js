/**
 * Light rays background — adapted from @react-bits/LightRays-JS-CSS
 * https://reactbits.dev
 */
...
export function createLightRays(container, options = {}) {
  ...
  mount.className = "light-rays-container";
  ...
  const draw = (timestamp) => {
    ...
    program.uniforms.iTime.value = ((timestamp - startTime) * 0.001) * settings.raysSpeed;
    program.uniforms.raysColor.value = hexToRgb(settings.raysColor);
