/**
 * Parallax starfield — adapted from @react-bits/Galaxy-JS-CSS
 * https://reactbits.dev
 */
...
export function createGalaxy(container, options = {}) {
  ...
  mount.className = "galaxy-container";
  container.appendChild(mount);

  const renderer = new Renderer({ alpha: settings.transparent, premultipliedAlpha: false });
  ...
  const draw = (timestamp) => {
    ...
    program.uniforms.uStarSpeed.value = (timestamp * 0.001 * settings.starSpeed) / 10.0;
