/**
 * Flowing aurora gradient background — adapted from @react-bits/Aurora-JS-CSS
 * https://reactbits.dev
 */
...
function colorStopsToUniform(stops) {
...
export function createAurora(container, options = {}) {
  ...
  mount.className = "aurora-container";
  ...
  let program = new Program(gl, {
    ...
    uniforms: {
      ...
      uColorStops: { value: colorStopsToUniform(settings.colorStops) },
  ...
  const draw = (timestamp) => {
    ...
    program.uniforms.uTime.value = elapsed * settings.speed * 0.1;
    program.uniforms.uAmplitude.value = settings.amplitude;
    program.uniforms.uBlend.value = settings.blend;
    program.uniforms.uColorStops.value = colorStopsToUniform(settings.colorStops);
